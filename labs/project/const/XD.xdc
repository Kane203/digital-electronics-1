...
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports {  SW_send }]; #IO_L21P_T3_DQS_14 Sch=sw[15]

## LEDs
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { LED }]; #IO_L18P_T2_A24_15 Sch=led
...
##CPU Reset Button
#set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { CPU_RESETN }]; #IO_L3P_T0_DQS_AD1P_15 Sch=cpu_reseAtn
...
set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { E16 }]; #IO_L11N_T1_SRCC_15 Sch=jb[7]
